 ...
 * under the License.
 *
 * CXformDynamicGet2Append.cpp
 *
 * IDENTIFICATION
 *	  src/backend/gporca/libgpopt/src/xforms/CXformDynamicGet2Append.cpp
 *
 *-------------------------------------------------------------------------
 */

#include "gpopt/xforms/CXformDynamicGet2Append.h"
...
//---------------------------------------------------------------------------
//	@function:
//		CXformDynamicGet2Append::CXformDynamicGet2Append
//
//	@doc:
//		Ctor
//
...
CXformDynamicGet2Append::Exfp(CExpressionHandle &exprhdl) const
{
...
//---------------------------------------------------------------------------
void
CXformDynamicGet2Append::Transform(CXformContext *pxfctxt,
								   CXformResult *pxfres,
