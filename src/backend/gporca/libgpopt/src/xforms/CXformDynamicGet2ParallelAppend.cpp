 ...
 * under the License.
 *
 * CXformDynamicGet2ParallelAppend.cpp
 *
 * IDENTIFICATION
 *	  src/backend/gporca/libgpopt/src/xforms/CXformDynamicGet2ParallelAppend.cpp
 *
 *-------------------------------------------------------------------------
 */

#include "gpopt/xforms/CXformDynamicGet2ParallelAppend.h"
...
//---------------------------------------------------------------------------
//	@function:
//		CXformDynamicGet2ParallelAppend::CXformDynamicGet2ParallelAppend
//
//	@doc:
//		Ctor
//
...
CXformDynamicGet2ParallelAppend::Exfp(CExpressionHandle &exprhdl) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CXformDynamicGet2Append::Transform
//
//	@doc:
...
//---------------------------------------------------------------------------
void
CXformDynamicGet2ParallelAppend::Transform(CXformContext *pxfctxt,
										   CXformResult *pxfres,
